...
model = ResNet(1, 7)
model.load_state_dict(torch.load('/Users/kartik/Desktop/ScienceFairCode/stitched_model_state_v2.pth',
                                 map_location=device))
img = cv2.imread('/Users/kartik/Desktop/ScienceFairCode/data/stitched/validation/Sad/img_validation_Sad_DataStitched_1.jpg')
imgT = img2tensor(img)
emotion = predict(img)
print(emotion)
